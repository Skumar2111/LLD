    ...
    public UserRegistrationDTO registerUser(UserRegistrationDTO userRegistrationDTO)
    {
       user_registration user_registration = mapUserRegistrationDetails(userRegistrationDTO);
        ...
        try {
            ...
            String json = ow.writeValueAsString(user_registration);
            kafkaProducerService.sendMessage("park-sure-verify",json);
    ...
    public UserRegistrationDTO getUserDetails(String user_id) {
        ...
        try {
            ...
            if (userRegistration != null) {
                ...
                throw new UserNotFoundException("User with id not found" + user_id);
